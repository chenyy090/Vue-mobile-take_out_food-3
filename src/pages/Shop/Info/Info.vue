  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" :class="classes[support.type]"
  ...
  export default {
    ...
    methods: {
      ...
      _initScroll() {
        ...
        const width = liWidth * count +　space * (count - 1)
